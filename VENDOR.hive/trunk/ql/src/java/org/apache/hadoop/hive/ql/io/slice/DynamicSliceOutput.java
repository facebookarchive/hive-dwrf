        ...
        extends SliceOutput
{
    ...
    {
        slice = Slices.ensureSize(slice, size + SizeOf.SIZE_OF_BYTE);
        slice.setByte(size, value);
        size += SizeOf.SIZE_OF_BYTE;
    }

    @Override
    public void writeShort(int value)
    {
        slice = Slices.ensureSize(slice, size + SizeOf.SIZE_OF_SHORT);
        slice.setShort(size, value);
        size += SizeOf.SIZE_OF_SHORT;
    }

    @Override
    public void writeInt(int value)
    {
        slice = Slices.ensureSize(slice, size + SizeOf.SIZE_OF_INT);
    ...
    {
        slice = Slices.ensureSize(slice, size + SizeOf.SIZE_OF_LONG);
    ...
    {
        slice = Slices.ensureSize(slice, size + SizeOf.SIZE_OF_DOUBLE);
